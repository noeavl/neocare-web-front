...
export class BabiesDetailComponent {
  ...
  pageSize = 4;
  currentPage = 1;
  constructor(private babiesService: BabiesService, private relativesService: RelativesService, private messageService: MessageService, private route: ActivatedRoute) {
